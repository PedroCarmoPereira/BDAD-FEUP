...
CREATE TABLE Estudante (
	...
	morada		    TEXT NOT NULL,
	curso	        INTEGER,
	FOREIGN KEY (curso) REFERENCES Curso(codigo) ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE Prof (
	...
	numGabin    INTEGER,
	FOREIGN KEY (numGabin) REFERENCES Gabinete(numero) ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE Curso (
	...
	nome      TEXT NOT NULL,
	diretor   INTEGER,
	FOREIGN KEY (diretor) REFERENCES Prof(profID) ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE StaffDoCurso (
	...
	FOREIGN KEY (staff) REFERENCES Staff(staffID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Leciona  (
	...
	FOREIGN KEY (prof) REFERENCES Prof(profID) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (curso) REFERENCES Curso(codigo) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE Lab (
	...
	FOREIGN KEY (coordenador) REFERENCES Prof(profID) ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE ProfAssocLab (
	...
	FOREIGN KEY (prof) REFERENCES Prof(profID) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (lab) REFERENCES Lab(labID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE ComissaoCientifica (
	...
	FOREIGN KEY (curso) REFERENCES Curso(codigo) ON DELETE CASCADE ON UPDATE CASCADE,
  	FOREIGN KEY (prof) REFERENCES Prof(profID) ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE ComissaoAcompanhamento (
	...
	FOREIGN KEY (curso) REFERENCES Curso(codigo) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (estudante) REFERENCES Estudante(estudanteID) ON DELETE SET NULL ON UPDATE CASCADE,
	FOREIGN KEY (prof) REFERENCES Prof(profID) ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE EstudanteNucleo (
	...
	FOREIGN KEY (estudante) REFERENCES Estudante(estudanteID) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (nucleo) REFERENCES Nucleo(nucleoID) ON DELETE CASCADE ON UPDATE CASCADE
);
